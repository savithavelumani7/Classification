# -*- coding: utf-8 -*-
"""
Created on Wed Mar  6 06:15:15 2024
...
if opt =="Customer Recomendation":
    ...
    def create_surprise_dataset(data):
        ...
        dataset = Dataset.load_from_df(data[['CustomerId', 'Sub-Category_y', 'Customer Rating']], reader)
        return dataset
    ...
    def main():
        ...
        if st.button('Generate Recommendations'):
            ...
            for prediction in sorted(predictions, key=lambda x: x.est, reverse=True)[:5]:
                st.write(f'Products: {prediction.iid}')
